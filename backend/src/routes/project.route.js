...
import { addMember, createProject, deleteProject, getAllProjects, getProject, projectMetrics, removeMember, transferOwnership, updateMembersRole, updateProject } from "../controllers/project.controller.js"
...
router.get('/:id/metrics', protectRoute, projectMetrics)
